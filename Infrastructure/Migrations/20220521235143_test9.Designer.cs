...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220521235143_test9")]
    partial class test9
    {
            ...
            modelBuilder.Entity("Infrastructure.Entities.Categories.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "moba",
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 972, DateTimeKind.Local).AddTicks(5454)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.City.CityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 956, DateTimeKind.Local).AddTicks(1057),
                            Name = "Seattle"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 2,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 956, DateTimeKind.Local).AddTicks(1067),
                            Name = "Tokyo"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Country.CountryEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 956, DateTimeKind.Local).AddTicks(1251),
                            Name = "USA"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 956, DateTimeKind.Local).AddTicks(1292),
                            Name = "Japan(OwO)"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Publisher.PublisherEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 972, DateTimeKind.Local).AddTicks(5282),
                            PublisherName = "valve"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            Password = "gstMSoMqGceImi5/dTRoYIJzLBSA2tJo723OAxNBwfk=",
                            Role = 1,
                            Salt = "VFYyo8EaGvRIOarZQj8vfA==",
                            TelephoneNumber = "551001100",
                            UserName = "string",
                            Verified = new DateTime(2022, 5, 22, 3, 51, 42, 970, DateTimeKind.Local).AddTicks(9344)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.UserBalance.UserBalanceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 972, DateTimeKind.Local).AddTicks(5120),
                            UserId = 1,
                            balance = 0.0
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Videogame.VideogameEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 972, DateTimeKind.Local).AddTicks(5380),
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameCategories.VideogameCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VideogameId = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 22, 3, 51, 42, 972, DateTimeKind.Local).AddTicks(5540)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameLikesList.VideogameLikesListEntity", b =>
                {
                    ...
                    b.ToTable("VideogameLikesListEntities");
                });
