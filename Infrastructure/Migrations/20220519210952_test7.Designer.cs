...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220519210952_test7")]
    partial class test7
    {
            ...
            modelBuilder.Entity("Infrastructure.Entities.Categories.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "moba",
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 695, DateTimeKind.Local).AddTicks(4442)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.City.CityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 679, DateTimeKind.Local).AddTicks(8050),
                            Name = "Seattle"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 2,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 679, DateTimeKind.Local).AddTicks(8060),
                            Name = "Tokyo"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Country.CountryEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 679, DateTimeKind.Local).AddTicks(8256),
                            Name = "USA"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 679, DateTimeKind.Local).AddTicks(8257),
                            Name = "Japan(OwO)"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Publisher.PublisherEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 695, DateTimeKind.Local).AddTicks(4274),
                            PublisherName = "valve"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            Password = "4a0CHoVTXHSaXGpX0kHWiRV2s6Hx3suEYfcPgt9cDIM=",
                            Role = 1,
                            Salt = "4Tn/9w3bmQ+AJ6Amy4l8nQ==",
                            TelephoneNumber = "551001100",
                            UserName = "string",
                            Verified = new DateTime(2022, 5, 20, 1, 9, 51, 693, DateTimeKind.Local).AddTicks(7472)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.UserBalance.UserBalanceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 695, DateTimeKind.Local).AddTicks(4178),
                            UserId = 1,
                            balance = 0.0
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Videogame.VideogameEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 695, DateTimeKind.Local).AddTicks(4371),
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameCategories.VideogameCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VideogameId = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 20, 1, 9, 51, 695, DateTimeKind.Local).AddTicks(4508)
                        });
                });
