...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220519234431_test8")]
    partial class test8
    {
            ...
            modelBuilder.Entity("Infrastructure.Entities.Categories.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "moba",
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 446, DateTimeKind.Local).AddTicks(12)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.City.CityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 430, DateTimeKind.Local).AddTicks(862),
                            Name = "Seattle"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 2,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 430, DateTimeKind.Local).AddTicks(872),
                            Name = "Tokyo"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Country.CountryEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 430, DateTimeKind.Local).AddTicks(1045),
                            Name = "USA"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 430, DateTimeKind.Local).AddTicks(1047),
                            Name = "Japan(OwO)"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Publisher.PublisherEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 445, DateTimeKind.Local).AddTicks(9842),
                            PublisherName = "valve"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            Password = "LzRuUFhWpGfRyjziS05djRa6sjwA48b11CcZ+cKzkZM=",
                            Role = 1,
                            Salt = "eEOZcZvC9Si06CXuhW6gLQ==",
                            TelephoneNumber = "551001100",
                            UserName = "string",
                            Verified = new DateTime(2022, 5, 20, 3, 44, 30, 444, DateTimeKind.Local).AddTicks(1412)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.UserBalance.UserBalanceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 445, DateTimeKind.Local).AddTicks(9724),
                            UserId = 1,
                            balance = 0.0
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Videogame.VideogameEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 445, DateTimeKind.Local).AddTicks(9938),
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameCategories.VideogameCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VideogameId = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 20, 3, 44, 30, 446, DateTimeKind.Local).AddTicks(95)
                        });
                });
