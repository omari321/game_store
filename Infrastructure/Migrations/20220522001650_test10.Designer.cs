...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220522001650_test10")]
            ...
            modelBuilder.Entity("Infrastructure.Entities.Categories.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "moba",
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8768)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.City.CityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 317, DateTimeKind.Local).AddTicks(8608),
                            Name = "Seattle"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 2,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 317, DateTimeKind.Local).AddTicks(8619),
                            Name = "Tokyo"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Country.CountryEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 317, DateTimeKind.Local).AddTicks(8813),
                            Name = "USA"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 317, DateTimeKind.Local).AddTicks(8815),
                            Name = "Japan(OwO)"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Publisher.PublisherEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8616),
                            PublisherName = "valve"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            Password = "Pr6fQwlSEID5O+Ri2NbPOtG32sTwa1yglVvTned795w=",
                            Role = 1,
                            Salt = "v4J2nNfd+rwJuDoolTIXpg==",
                            TelephoneNumber = "551001100",
                            UserName = "string",
                            Verified = new DateTime(2022, 5, 22, 4, 16, 49, 333, DateTimeKind.Local).AddTicks(2428)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.UserBalance.UserBalanceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8484),
                            UserId = 1,
                            balance = 0.0
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.Videogame.VideogameEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8695),
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameCategories.VideogameCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VideogameId = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8853)
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Entities.VideogameLikes.VideogameLikesEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 22, 4, 16, 49, 334, DateTimeKind.Local).AddTicks(8939),
                            DislikesCount = 0,
                            LikesCount = 0,
                            VideogameId = 1
                        });
